#different importations
import time # to set a delay between message
import subprocess #to launch linux command
import sys #to shut down processes with sys.exit()
import os
import signal
